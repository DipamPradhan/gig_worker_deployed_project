  ...
  const Availability = () => {
    ...
    // fetching worker profile from database
    ...
    // handlng the updation of status of worker availability
    ...
    // worker document check if worker can change availability
    const canBeActive =
    ...
    // list of availability option for worker
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <ul className="text-sm text-yellow-700 list-disc list-inside space-y-1">
                  ...
                  {/* if worker has not verified document */}
                  {!workerProfile?.has_verified_document && (
                    <li>
                      A verified document{" "}
                      <button
