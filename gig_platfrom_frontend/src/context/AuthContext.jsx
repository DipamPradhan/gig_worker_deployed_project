  ...
  // custom hook  else we would use eveytime useContext(AuthContext)
  export const useAuth = () => {
    // allow component to read context by future components
    const context = useContext(AuthContext);
    if (!context) {
      // components must be wrapped by auth provider to use this context
