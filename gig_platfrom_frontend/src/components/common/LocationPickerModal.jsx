  ...
  const LocationPickerModal = ({
    ...
    // useMemo react remember the object values and change only when the data change 
    // else it creates new object everytime for same location value

    // Stores a calculated value so React doesn't calculate it on every render.
    ...
    // run when initial positon change
    useEffect(() => {
      if (isOpen) {
    ...
    // if user has location , it opens there center else ktm
      ...
      <div className="fixed inset-0 z-50 overflow-y-auto">
        ...
        <div className="flex min-h-full items-center justify-center p-4">
          <div className="relative bg-white rounded-lg shadow-xl max-w-3xl w-full p-5">
            ...
            {/* provide map  container and selection feature */}
            <div className="h-[360px] w-full rounded-md overflow-hidden border border-gray-200 mb-4">
              ...
              >
                ...
                {pickedPosition && (
                  ...
                  >
                    {/* message shown when location picked */}
              ...
              {/* shows in the bottom the picked lat and long */}
            <div className="text-sm text-gray-700 mb-4">
              {pickedPosition ? (
                ...
                {/* select or cancel picking location */}
